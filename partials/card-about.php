						...
						<div class="row client-items">
								...
								<div class="client-item">
									<div class="image">
										<a target="_blank" href="https://www.google.com">
											<img src="<?=get_template_directory_uri()?>/assets/images/clients/client_1.png" alt="" />
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col col-d-3 col-t-3 col-m-6 border-line-v">
								<div class="client-item">
									<div class="image">
										<a target="_blank" href="https://www.google.com">
											<img src="<?=get_template_directory_uri()?>/assets/images/clients/client_2.png" alt="" />
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col col-d-3 col-t-3 col-m-6 border-line-v">
								<div class="client-item">
									<div class="image">
										<a target="_blank" href="https://www.google.com">
											<img src="<?=get_template_directory_uri()?>/assets/images/clients/client_3.png" alt="" />
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col col-d-3 col-t-3 col-m-6 border-line-v">
								<div class="client-item">
									<div class="image">
										<a target="_blank" href="https://www.google.com">
											<img src="<?=get_template_directory_uri()?>/assets/images/clients/client_4.png" alt="" />
										</a>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col col-d-12 col-t-12 col-m-12 border-line-v">
								<div class="revs-item">
									...
									<div class="user">
										<div class="img">
											<img src="<?=get_template_directory_uri()?>/assets/images/profile.png" alt="Ryan Adlard" />
										</div>
										<div class="info">
